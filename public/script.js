...
const WORDS_BY_LEVEL = {
  ...
  // ─────────────────────────────────────────
  1: [
    { en: 'I eat an apple.',              blank: 'apple',     answer: 'manzana',     hint: 'sustantivo' , es: 'Yo como una manzana.'},
    { en: 'She drinks water.',            blank: 'water',     answer: 'agua',        hint: 'sustantivo' , es: 'Ella bebe agua.'},
    { en: 'They live in a house.',        blank: 'house',     answer: 'casa',        hint: 'sustantivo' , es: 'Ellos viven en una casa.'},
    { en: 'He has a dog.',                blank: 'dog',       answer: 'perro',       hint: 'sustantivo' , es: 'Él tiene un perro.'},
    { en: 'She loves her cat.',           blank: 'cat',       answer: 'gato',        hint: 'sustantivo' , es: 'Ella ama a su gato.'},
    { en: 'I read a book.',               blank: 'book',      answer: 'libro',       hint: 'sustantivo' , es: 'Yo leo un libro.'},
    { en: 'He calls his friend.',         blank: 'friend',    answer: 'amigo',       hint: 'sustantivo' , es: 'Él llama a su amigo.'},
    { en: 'We have a family.',            blank: 'family',    answer: 'familia',     hint: 'sustantivo' , es: 'Nosotros tenemos una familia.'},
    { en: 'I need food.',                 blank: 'food',      answer: 'comida',      hint: 'sustantivo' , es: 'Yo necesito comida.'},
    { en: 'She has no time.',             blank: 'time',      answer: 'tiempo',      hint: 'sustantivo' , es: 'Ella no tiene tiempo.'},
    { en: 'It is a sunny day.',           blank: 'day',       answer: 'día',         hint: 'sustantivo' , es: 'Es un día soleado.'},
    { en: 'I sleep at night.',            blank: 'night',     answer: 'noche',       hint: 'sustantivo' , es: 'Yo duermo de noche.'},
    { en: 'She goes to school.',          blank: 'school',    answer: 'escuela',     hint: 'sustantivo' , es: 'Ella va a la escuela.'},
    { en: 'He is a good teacher.',        blank: 'teacher',   answer: 'maestro',     hint: 'sustantivo' , es: 'Él es un buen maestro.'},
    { en: 'I sit on the chair.',          blank: 'chair',     answer: 'silla',       hint: 'sustantivo' , es: 'Yo me siento en la silla.'},
    { en: 'The food is on the table.',    blank: 'table',     answer: 'mesa',        hint: 'sustantivo' , es: 'La comida está en la mesa.'},
    { en: 'I open the window.',           blank: 'window',    answer: 'ventana',     hint: 'sustantivo' , es: 'Yo abro la ventana.'},
    { en: 'Close the door, please.',      blank: 'door',      answer: 'puerta',      hint: 'sustantivo' , es: 'Cierra la puerta, por favor.'},
    { en: 'I drive a car.',               blank: 'car',       answer: 'carro',       hint: 'sustantivo' , es: 'Yo manejo un carro.'},
    { en: 'We take the bus.',             blank: 'bus',       answer: 'autobús',     hint: 'sustantivo' , es: 'Nosotros tomamos el autobús.'},
    { en: 'I walk down the street.',      blank: 'street',    answer: 'calle',       hint: 'sustantivo' , es: 'Yo camino por la calle.'},
    { en: 'She lives in the city.',       blank: 'city',      answer: 'ciudad',      hint: 'sustantivo' , es: 'Ella vive en la ciudad.'},
    { en: 'He is from this country.',     blank: 'country',   answer: 'país',        hint: 'sustantivo' , es: 'Él es de este país.'},
    { en: 'I love music.',                blank: 'music',     answer: 'música',      hint: 'sustantivo' , es: 'Yo amo la música.'},
    { en: 'She checks her phone.',        blank: 'phone',     answer: 'teléfono',    hint: 'sustantivo' , es: 'Ella revisa su teléfono.'},
    { en: 'I need money.',                blank: 'money',     answer: 'dinero',      hint: 'sustantivo' , es: 'Yo necesito dinero.'},
    { en: 'He goes to work.',             blank: 'work',      answer: 'trabajo',     hint: 'sustantivo' , es: 'Él va al trabajo.'},
    { en: 'We play a game.',              blank: 'game',      answer: 'juego',       hint: 'sustantivo' , es: 'Nosotros jugamos un juego.'},
    { en: 'I see the moon.',              blank: 'moon',      answer: 'luna',        hint: 'sustantivo' , es: 'Yo veo la luna.'},
    { en: 'I see the sun.',               blank: 'sun',       answer: 'sol',         hint: 'sustantivo' , es: 'Yo veo el sol.'},
    { en: 'It starts to rain.',           blank: 'rain',      answer: 'llover / lluvia', hint: 'sustantivo/verbo' , es: 'Empieza a llover.'},
    { en: 'We sit under the tree.',       blank: 'tree',      answer: 'árbol',       hint: 'sustantivo' , es: 'Nos sentamos bajo el árbol.'},
    { en: 'She picks a flower.',          blank: 'flower',    answer: 'flor',        hint: 'sustantivo' , es: 'Ella recoge una flor.'},
    { en: 'A bird sings outside.',        blank: 'bird',      answer: 'pájaro',      hint: 'sustantivo' , es: 'Un pájaro canta afuera.'},
    { en: 'I catch a fish.',              blank: 'fish',      answer: 'pez',         hint: 'sustantivo' , es: 'Yo atrapo un pez.'},
    { en: 'I eat bread for breakfast.',   blank: 'bread',     answer: 'pan',         hint: 'sustantivo' , es: 'Yo como pan en el desayuno.'},
    { en: 'She drinks milk.',             blank: 'milk',      answer: 'leche',       hint: 'sustantivo' , es: 'Ella bebe leche.'},
    { en: 'He drinks coffee.',            blank: 'coffee',    answer: 'café',        hint: 'sustantivo' , es: 'Él bebe café.'},
    { en: 'She prefers tea.',             blank: 'tea',       answer: 'té',          hint: 'sustantivo' , es: 'Ella prefiere el té.'},
    { en: 'He wears a shirt.',            blank: 'shirt',     answer: 'camisa',      hint: 'sustantivo' , es: 'Él usa una camisa.'},
    { en: 'I lost my shoe.',              blank: 'shoe',      answer: 'zapato',      hint: 'sustantivo' , es: 'Perdí mi zapato.'},
    { en: 'She wears a hat.',             blank: 'hat',       answer: 'sombrero',    hint: 'sustantivo' , es: 'Ella usa un sombrero.'},
    { en: 'I feel it in my heart.',       blank: 'heart',     answer: 'corazón',     hint: 'sustantivo' , es: 'Lo siento en mi corazón.'},
    { en: 'Write the word here.',         blank: 'word',      answer: 'palabra',     hint: 'sustantivo' , es: 'Escribe la palabra aquí.'},
    { en: 'Say the number.',              blank: 'number',    answer: 'número',      hint: 'sustantivo' , es: 'Di el número.'},
    { en: 'I have a dream.',              blank: 'dream',     answer: 'sueño',       hint: 'sustantivo' , es: 'Yo tengo un sueño.'},
    { en: 'She cleans the room.',         blank: 'room',      answer: 'habitación',  hint: 'sustantivo' , es: 'Ella limpia la habitación.'},
    { en: 'He cooks in the kitchen.',     blank: 'kitchen',   answer: 'cocina',      hint: 'sustantivo' , es: 'Él cocina en la cocina.'},
    { en: 'I use the bathroom.',          blank: 'bathroom',  answer: 'baño',        hint: 'sustantivo' , es: 'Yo uso el baño.'},
    { en: 'We work in the garden.',       blank: 'garden',    answer: 'jardín',      hint: 'sustantivo' , es: 'Nosotros trabajamos en el jardín.'},
    { en: 'Kids play in the park.',       blank: 'park',      answer: 'parque',      hint: 'sustantivo' , es: 'Los niños juegan en el parque.'},
    { en: 'I buy it at the store.',       blank: 'store',     answer: 'tienda',      hint: 'sustantivo' , es: 'Lo compro en la tienda.'},
    { en: 'She shops at the market.',     blank: 'market',    answer: 'mercado',     hint: 'sustantivo' , es: 'Ella compra en el mercado.'},
    { en: 'He goes to the bank.',         blank: 'bank',      answer: 'banco',       hint: 'sustantivo' , es: 'Él va al banco.'},
    { en: 'She works at the hospital.',   blank: 'hospital',  answer: 'hospital',    hint: 'sustantivo' , es: 'Ella trabaja en el hospital.'},
    { en: 'The doctor helps the child.',  blank: 'doctor',    answer: 'médico',      hint: 'sustantivo' , es: 'El médico ayuda al niño.'},
    { en: 'The baby cries at night.',     blank: 'baby',      answer: 'bebé',        hint: 'sustantivo' , es: 'El bebé llora de noche.'},
    { en: 'The man reads the paper.',     blank: 'paper',     answer: 'periódico',   hint: 'sustantivo' , es: 'El hombre lee el periódico.'},
    { en: 'The woman cooks dinner.',      blank: 'dinner',    answer: 'cena',        hint: 'sustantivo' , es: 'La mujer cocina la cena.'},
    { en: 'The boy runs fast.',           blank: 'boy',       answer: 'chico / niño', hint: 'sustantivo' , es: 'El chico corre rápido.'},
    { en: 'The girl sings well.',         blank: 'girl',      answer: 'chica / niña', hint: 'sustantivo' , es: 'La chica canta bien.'},
    { en: 'My mother is kind.',           blank: 'mother',    answer: 'madre',       hint: 'sustantivo' , es: 'Mi madre es amable.'},
    { en: 'His father works hard.',       blank: 'father',    answer: 'padre',       hint: 'sustantivo' , es: 'Su padre trabaja duro.'},
    { en: 'My brother is tall.',          blank: 'brother',   answer: 'hermano',     hint: 'sustantivo' , es: 'Mi hermano es alto.'},
    { en: 'Her sister is smart.',         blank: 'sister',    answer: 'hermana',     hint: 'sustantivo' , es: 'Su hermana es inteligente.'},
    { en: 'This year is busy.',           blank: 'year',      answer: 'año',         hint: 'sustantivo' , es: 'Este año está ocupado.'},
    { en: 'The week starts Monday.',      blank: 'week',      answer: 'semana',      hint: 'sustantivo' , es: 'La semana empieza el lunes.'},
    { en: 'This month is cold.',          blank: 'month',     answer: 'mes',         hint: 'sustantivo' , es: 'Este mes hace frío.'},
    { en: 'Wait one minute.',             blank: 'minute',    answer: 'minuto',      hint: 'sustantivo' , es: 'Espera un minuto.'},
    { en: 'It is very hot.',              blank: 'hot',       answer: 'caliente / calor', hint: 'adjetivo' , es: 'Hace mucho calor.'},
    { en: 'The water is cold.',           blank: 'cold',      answer: 'frío',        hint: 'adjetivo' , es: 'El agua está fría.'},
    { en: 'He is a big man.',             blank: 'big',       answer: 'grande',      hint: 'adjetivo' , es: 'Él es un hombre grande.'},
    { en: 'It is a small house.',         blank: 'small',     answer: 'pequeño',     hint: 'adjetivo' , es: 'Es una casa pequeña.'},
    { en: 'She is a good person.',        blank: 'good',      answer: 'buena / bueno', hint: 'adjetivo' , es: 'Ella es una buena persona.'},
    { en: 'This is bad news.',            blank: 'bad',       answer: 'mala / malo', hint: 'adjetivo' , es: 'Esta es una mala noticia.'},
    { en: 'She is very happy.',           blank: 'happy',     answer: 'feliz',       hint: 'adjetivo' , es: 'Ella está muy feliz.'},
    { en: 'He looks sad today.',          blank: 'sad',       answer: 'triste',      hint: 'adjetivo' , es: 'Él parece triste hoy.'},
    { en: 'The shop is open now.',        blank: 'open',      answer: 'abierta / abierto', hint: 'adjetivo' , es: 'La tienda está abierta ahora.'},
    { en: 'The bank is closed today.',    blank: 'closed',    answer: 'cerrado',     hint: 'adjetivo' , es: 'El banco está cerrado hoy.'},
    { en: 'She always says yes.',         blank: 'always',    answer: 'siempre',     hint: 'adverbio' , es: 'Ella siempre dice que sí.'},
    { en: 'Walk slowly, please.',         blank: 'slowly',    answer: 'despacio',    hint: 'adverbio' , es: 'Camina despacio, por favor.'},
  ...
  // ─────────────────────────────────────────
  2: [
    { en: 'I booked a hotel near the airport.',         blank: 'hotel / airport',        answer: 'hotel / aeropuerto',             hint: 'viaje' , es: 'Reservé un hotel cerca del aeropuerto.'},
    { en: 'She bought a ticket for the concert.',       blank: 'ticket / concert',       answer: 'boleto / concierto',             hint: 'entretenimiento' , es: 'Ella compró un boleto para el concierto.'},
    { en: 'We planned a long travel.',                  blank: 'planned / travel',       answer: 'planeamos / viaje',              hint: 'viaje' , es: 'Planeamos un largo viaje.'},
    { en: 'The beach is near the city.',                blank: 'beach / city',           answer: 'playa / ciudad',                 hint: 'lugares' , es: 'La playa está cerca de la ciudad.'},
    { en: 'We hiked up the mountain.',                  blank: 'hiked / mountain',       answer: 'caminamos / montaña',            hint: 'naturaleza' , es: 'Nosotros escalamos la montaña.'},
    { en: 'The river crosses the forest.',              blank: 'river / forest',         answer: 'río / bosque',                   hint: 'naturaleza' , es: 'El río cruza el bosque.'},
    { en: 'The island has no bridge.',                  blank: 'island / bridge',        answer: 'isla / puente',                  hint: 'geografía' , es: 'La isla no tiene puente.'},
    { en: 'She reads the map in the village.',          blank: 'map / village',          answer: 'mapa / pueblo',                  hint: 'lugares' , es: 'Ella lee el mapa en el pueblo.'},
    { en: 'He studies a foreign language.',             blank: 'studies / language',     answer: 'estudia / idioma',               hint: 'educación' , es: 'Él estudia un idioma extranjero.'},
    { en: 'Our class starts at eight.',                 blank: 'class / eight',          answer: 'clase / ocho',                   hint: 'educación' , es: 'Nuestra clase empieza a las ocho.'},
    { en: 'She finished her homework before the exam.', blank: 'homework / exam',        answer: 'tarea / examen',                 hint: 'educación' , es: 'Ella terminó su tarea antes del examen.'},
    { en: 'He got a good grade at the university.',     blank: 'grade / university',     answer: 'calificación / universidad',     hint: 'educación' , es: 'Él obtuvo una buena calificación en la universidad.'},
    { en: 'I return books to the library.',             blank: 'books / library',        answer: 'libros / biblioteca',            hint: 'educación' , es: 'Yo regreso libros a la biblioteca.'},
    { en: 'We have a meeting at the office.',           blank: 'meeting / office',       answer: 'reunión / oficina',              hint: 'trabajo' , es: 'Tenemos una reunión en la oficina.'},
    { en: 'His salary covers the rent.',                blank: 'salary / rent',          answer: 'salario / alquiler',             hint: 'finanzas' , es: 'Su salario cubre el alquiler.'},
    { en: 'She fixes the computer with the keyboard.',  blank: 'computer / keyboard',   answer: 'computadora / teclado',          hint: 'tecnología' , es: 'Ella arregla la computadora con el teclado.'},
    { en: 'The screen shows a new email.',              blank: 'screen / email',         answer: 'pantalla / correo electrónico',  hint: 'tecnología' , es: 'La pantalla muestra un nuevo correo electrónico.'},
    { en: 'Change your password on the website.',       blank: 'password / website',     answer: 'contraseña / sitio web',         hint: 'tecnología' , es: 'Cambia tu contraseña en el sitio web.'},
    { en: 'She posts a picture at the concert.',        blank: 'picture / concert',      answer: 'foto / concierto',               hint: 'redes sociales' , es: 'Ella publica una foto en el concierto.'},
    { en: 'We watch a movie on the big screen.',        blank: 'movie / screen',         answer: 'película / pantalla',            hint: 'entretenimiento' , es: 'Vemos una película en la pantalla grande.'},
    { en: 'Our team won the match.',                    blank: 'team / match',           answer: 'equipo / partido',               hint: 'deportes' , es: 'Nuestro equipo ganó el partido.'},
    { en: 'The player scored and won the prize.',       blank: 'player / prize',         answer: 'jugador / premio',               hint: 'deportes' , es: 'El jugador anotó y ganó el premio.'},
    { en: 'She organizes a birthday party.',            blank: 'birthday / party',       answer: 'cumpleaños / fiesta',            hint: 'celebraciones' , es: 'Ella organiza una fiesta de cumpleaños.'},
    { en: 'I bought a gift and a cake.',                blank: 'gift / cake',            answer: 'regalo / pastel',                hint: 'celebraciones' , es: 'Compré un regalo y un pastel.'},
    { en: 'They had dinner at a restaurant.',           blank: 'dinner / restaurant',    answer: 'cena / restaurante',             hint: 'comida' , es: 'Ellos cenaron en un restaurante.'},
    { en: 'We ordered from the menu.',                  blank: 'ordered / menu',         answer: 'pedimos / menú',                 hint: 'comida' , es: 'Pedimos del menú.'},
    { en: 'The waiter brought the bill.',               blank: 'waiter / bill',          answer: 'mesero / cuenta',                hint: 'comida' , es: 'El mesero trajo la cuenta.'},
    { en: 'The doctor gave him medicine.',              blank: 'doctor / medicine',      answer: 'médico / medicina',              hint: 'salud' , es: 'El médico le dio medicina.'},
    { en: 'She has a fever and a headache.',            blank: 'fever / headache',       answer: 'fiebre / dolor de cabeza',       hint: 'salud' , es: 'Ella tiene fiebre y dolor de cabeza.'},
    { en: 'I got medicine at the pharmacy.',            blank: 'medicine / pharmacy',    answer: 'medicina / farmacia',            hint: 'salud' , es: 'Conseguí medicina en la farmacia.'},
    { en: 'Daily exercise improves health.',            blank: 'exercise / health',      answer: 'ejercicio / salud',              hint: 'salud' , es: 'El ejercicio diario mejora la salud.'},
    { en: 'Check the weather before traveling.',        blank: 'weather / traveling',    answer: 'clima / viajar',                 hint: 'clima' , es: 'Revisa el clima antes de viajar.'},
    { en: 'A cloud covers the sun.',                    blank: 'cloud / sun',            answer: 'nube / sol',                     hint: 'clima' , es: 'Una nube cubre el sol.'},
    { en: 'Strong wind brings the storm.',              blank: 'wind / storm',           answer: 'viento / tormenta',              hint: 'clima' , es: 'El viento fuerte trae la tormenta.'},
    { en: 'Snow falls every winter season.',            blank: 'snow / winter',          answer: 'nieve / invierno',               hint: 'estaciones' , es: 'La nieve cae cada estación de invierno.'},
    { en: 'Flowers bloom in the spring.',               blank: 'flowers / spring',       answer: 'flores / primavera',             hint: 'estaciones' , es: 'Las flores florecen en primavera.'},
    { en: 'We swim at the beach in summer.',            blank: 'swim / summer',          answer: 'nadamos / verano',               hint: 'estaciones' , es: 'Nadamos en la playa en verano.'},
    { en: 'Leaves fall in autumn.',                     blank: 'leaves / autumn',        answer: 'hojas / otoño',                  hint: 'estaciones' , es: 'Las hojas caen en otoño.'},
    { en: 'The lion hunts in the forest.',              blank: 'lion / forest',          answer: 'león / bosque',                  hint: 'animales' , es: 'El león caza en el bosque.'},
    { en: 'The monkey climbs the tree.',                blank: 'monkey / tree',          answer: 'mono / árbol',                   hint: 'animales' , es: 'El mono trepa el árbol.'},
    { en: 'The rabbit hides from the snake.',           blank: 'rabbit / snake',         answer: 'conejo / serpiente',             hint: 'animales' , es: 'El conejo se esconde de la serpiente.'},
    { en: 'The horse and the cow are on the farm.',     blank: 'horse / cow',            answer: 'caballo / vaca',                 hint: 'animales' , es: 'El caballo y la vaca están en la granja.'},
    { en: 'She wore a red shirt and blue shoes.',       blank: 'shirt / shoes',          answer: 'camisa / zapatos',               hint: 'ropa' , es: 'Ella usó una camisa roja y zapatos azules.'},
    { en: 'The black cat sat on the white chair.',      blank: 'black / white',          answer: 'negro / blanco',                 hint: 'colores' , es: 'El gato negro se sentó en la silla blanca.'},
    { en: 'Mix purple and pink for brown.',             blank: 'purple / pink',          answer: 'morado / rosa',                  hint: 'colores' , es: 'Mezcla morado y rosa para obtener marrón.'},
    { en: 'The tall man and the short woman talked.',   blank: 'tall / short',           answer: 'alto / baja',                    hint: 'opuestos' , es: 'El hombre alto y la mujer baja hablaron.'},
    { en: 'The heavy box and the light bag are here.',  blank: 'heavy / light',          answer: 'pesada / ligera',                hint: 'opuestos' , es: 'La caja pesada y la bolsa ligera están aquí.'},
    { en: 'Keep it clean and quiet.',                   blank: 'clean / quiet',          answer: 'limpio / tranquilo',             hint: 'adjetivos' , es: 'Mantenlo limpio y tranquilo.'},
    { en: 'She is busy but free tonight.',              blank: 'busy / free',            answer: 'ocupada / libre',                hint: 'adjetivos' , es: 'Ella está ocupada pero libre esta noche.'},
    { en: 'We had breakfast before the exam.',          blank: 'breakfast / exam',       answer: 'desayuno / examen',              hint: 'comida + estudio' , es: 'Desayunamos antes del examen.'},
    { en: 'He ordered dinner from the menu.',           blank: 'dinner / menu',          answer: 'cena / menú',                    hint: 'comida' , es: 'Él pidió la cena del menú.'},
    { en: 'He drives the car to the airport.',          blank: 'car / airport',          answer: 'carro / aeropuerto',             hint: 'transporte' , es: 'Él conduce el carro al aeropuerto.'},
    { en: 'She walks her dog in the park.',             blank: 'dog / park',             answer: 'perro / parque',                 hint: 'actividad' , es: 'Ella pasea a su perro en el parque.'},
    { en: 'They read a book in the library.',           blank: 'book / library',         answer: 'libro / biblioteca',             hint: 'educación' , es: 'Ellos leyeron un libro en la biblioteca.'},
    { en: 'We drank coffee and tea.',                   blank: 'coffee / tea',           answer: 'café / té',                      hint: 'bebidas' , es: 'Bebimos café y té.'},
    { en: 'He saved money at the bank.',                blank: 'money / bank',           answer: 'dinero / banco',                 hint: 'finanzas' , es: 'Él ahorró dinero en el banco.'},
    { en: 'They crossed the bridge over the river.',    blank: 'bridge / river',         answer: 'puente / río',                   hint: 'geografía' , es: 'Ellos cruzaron el puente sobre el río.'},
    { en: 'The bird flew over the forest.',             blank: 'bird / forest',          answer: 'pájaro / bosque',                hint: 'naturaleza' , es: 'El pájaro voló sobre el bosque.'},
    { en: 'She learned the language in the village.',   blank: 'language / village',     answer: 'idioma / pueblo',                hint: 'educación' , es: 'Ella aprendió el idioma en el pueblo.'},
    { en: 'He used the map to find the island.',        blank: 'map / island',           answer: 'mapa / isla',                    hint: 'viaje' , es: 'Él usó el mapa para encontrar la isla.'},
    { en: 'I need water and food right now.',           blank: 'water / food',           answer: 'agua / comida',                  hint: 'necesidades' , es: 'Necesito agua y comida ahora mismo.'},
    { en: 'She left her phone and wallet behind.',      blank: 'phone / wallet',         answer: 'teléfono / cartera',             hint: 'objetos personales' , es: 'Ella dejó su teléfono y cartera atrás.'},
    { en: 'The doctor and the teacher help people.',    blank: 'doctor / teacher',       answer: 'médico / maestro',               hint: 'profesiones' , es: 'El médico y el maestro ayudan a las personas.'},
    { en: 'My brother and sister came to the party.',   blank: 'brother / sister',       answer: 'hermano / hermana',              hint: 'familia' , es: 'Mi hermano y hermana vinieron a la fiesta.'},
    { en: 'The man and the woman shared a meal.',       blank: 'man / woman',            answer: 'hombre / mujer',                 hint: 'personas' , es: 'El hombre y la mujer compartieron una comida.'},
    { en: 'We need a computer and internet.',           blank: 'computer / internet',    answer: 'computadora / internet',         hint: 'tecnología' , es: 'Necesitamos una computadora e internet.'},
    { en: 'She bought a camera at the market.',         blank: 'camera / market',        answer: 'cámara / mercado',               hint: 'compras' , es: 'Ella compró una cámara en el mercado.'},
    { en: 'He lost his ticket and his map.',            blank: 'ticket / map',           answer: 'boleto / mapa',                  hint: 'viaje' , es: 'Él perdió su boleto y su mapa.'},
    { en: 'The pig and the chicken are on the farm.',   blank: 'pig / chicken',          answer: 'cerdo / pollo',                  hint: 'animales' , es: 'El cerdo y el pollo están en la granja.'},
    { en: 'They watched the sunset at the beach.',      blank: 'sunset / beach',         answer: 'atardecer / playa',              hint: 'naturaleza' , es: 'Vieron el atardecer en la playa.'},
    { en: 'The waiter and the cook work together.',     blank: 'waiter / cook',          answer: 'mesero / cocinero',              hint: 'profesiones' , es: 'El mesero y el cocinero trabajan juntos.'},
    { en: 'She studies and works at the same time.',    blank: 'studies / works',        answer: 'estudia / trabaja',              hint: 'verbos' , es: 'Ella estudia y trabaja al mismo tiempo.'},
    { en: 'He writes a report in the office.',          blank: 'report / office',        answer: 'informe / oficina',              hint: 'trabajo' , es: 'Él escribe un informe en la oficina.'},
    { en: 'The storm hit the city and the village.',    blank: 'city / village',         answer: 'ciudad / pueblo',                hint: 'lugares' , es: 'La tormenta golpeó la ciudad y el pueblo.'},
    { en: 'She mixed yellow and blue for green.',       blank: 'yellow / blue',          answer: 'amarillo / azul',                hint: 'colores' , es: 'Ella mezcló amarillo y azul para obtener verde.'},
    { en: 'He wore a hat and a brown shirt.',           blank: 'hat / shirt',            answer: 'sombrero / camisa',              hint: 'ropa' , es: 'Él usó un sombrero y una camisa marrón.'},
    { en: 'They drank milk and coffee after dinner.',   blank: 'milk / dinner',          answer: 'leche / cena',                   hint: 'comida' , es: 'Ellos bebieron leche y café después de la cena.'},
    { en: 'She cleaned the kitchen and the bathroom.',  blank: 'kitchen / bathroom',     answer: 'cocina / baño',                  hint: 'hogar' , es: 'Ella limpió la cocina y el baño.'},
    { en: 'The garden and the park were beautiful.',    blank: 'garden / park',          answer: 'jardín / parque',                hint: 'lugares' , es: 'El jardín y el parque eran hermosos.'},
    { en: 'He saved the contract and the report.',      blank: 'contract / report',      answer: 'contrato / informe',             hint: 'trabajo' , es: 'Él guardó el contrato y el informe.'},
    { en: 'She bought shoes and a jacket.',             blank: 'shoes / jacket',         answer: 'zapatos / chaqueta',             hint: 'ropa' , es: 'Ella compró zapatos y una chaqueta.'},
    { en: 'They drove past the church and the school.', blank: 'church / school',        answer: 'iglesia / escuela',              hint: 'lugares' , es: 'Condujeron frente a la iglesia y la escuela.'},
    { en: 'He repairs cars and trucks.',                blank: 'cars / trucks',          answer: 'carros / camiones',              hint: 'transporte' , es: 'Él repara carros y camiones.'},
    { en: 'She baked bread and cookies.',               blank: 'bread / cookies',        answer: 'pan / galletas',                 hint: 'comida' , es: 'Ella hornó pan y galletas.'},
    { en: 'He painted the wall and the ceiling.',       blank: 'wall / ceiling',         answer: 'pared / techo',                  hint: 'hogar' , es: 'Él pintó la pared y el techo.'},
    { en: 'The cat and the mouse ran fast.',            blank: 'cat / mouse',            answer: 'gato / ratón',                   hint: 'animales' , es: 'El gato y el ratón corrieron rápido.'},
    { en: 'She planted roses and sunflowers.',          blank: 'roses / sunflowers',     answer: 'rosas / girasoles',              hint: 'naturaleza' , es: 'Ella plantó rosas y girasoles.'},
    { en: 'He fixed the door and the window.',          blank: 'door / window',          answer: 'puerta / ventana',               hint: 'hogar' , es: 'Él arregló la puerta y la ventana.'},
    { en: 'They swam in the lake and the river.',       blank: 'lake / river',           answer: 'lago / río',                     hint: 'naturaleza' , es: 'Ellos nadaron en el lago y el río.'},
    { en: 'She plays the guitar and the piano.',        blank: 'guitar / piano',         answer: 'guitarra / piano',               hint: 'música' , es: 'Ella toca la guitarra y el piano.'},
    { en: 'He wore a suit and a tie.',                  blank: 'suit / tie',             answer: 'traje / corbata',                hint: 'ropa' , es: 'Él usó un traje y una corbata.'},
    { en: 'The nurse and the doctor treated the patient.', blank: 'nurse / patient',     answer: 'enfermera / paciente',           hint: 'salud' , es: 'La enfermera y el médico atendieron al paciente.'},
    { en: 'She bought rice and beans at the store.',    blank: 'rice / beans',           answer: 'arroz / frijoles',               hint: 'comida' , es: 'Ella compró arroz y frijoles en la tienda.'},
    { en: 'He broke the cup and the plate.',            blank: 'cup / plate',            answer: 'taza / plato',                   hint: 'hogar' , es: 'Él rompió la taza y el plato.'},
    { en: 'The spider and the fly are insects.',        blank: 'spider / fly',           answer: 'araña / mosca',                  hint: 'animales' , es: 'La araña y la mosca son insectos.'},
    { en: 'She wore a ring and a necklace.',            blank: 'ring / necklace',        answer: 'anillo / collar',                hint: 'accesorios' , es: 'Ella usó un anillo y un collar.'},
    { en: 'He read the letter and the contract.',       blank: 'letter / contract',      answer: 'carta / contrato',               hint: 'documentos' , es: 'Él leyó la carta y el contrato.'},
    { en: 'They visited the museum and the castle.',    blank: 'museum / castle',        answer: 'museo / castillo',               hint: 'turismo' , es: 'Ellos visitaron el museo y el castillo.'},
    { en: 'She drank juice and water for breakfast.',   blank: 'juice / water',          answer: 'jugo / agua',                    hint: 'bebidas' , es: 'Ella bebió jugo y agua en el desayuno.'},
    { en: 'The pilot and the passenger boarded the plane.', blank: 'pilot / passenger', answer: 'piloto / pasajero',              hint: 'viaje' , es: 'El piloto y el pasajero abordaron el avión.'},
  ],
